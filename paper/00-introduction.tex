...
Our estimand is market inefficiency, which we define as the relative level of the market's error in its present value of future prices, when using available information.
