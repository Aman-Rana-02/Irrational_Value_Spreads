...
\begin{figure}[h!]
    ...
    the squares of the red distances. To construct a timeseries of the $Beta\_SSE$ score, we run this regression for shingled five-year windows and plot their scores.}
